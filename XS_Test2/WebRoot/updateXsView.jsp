			...
			<table border="0" cellspacing="1" cellpadding="8" width="500">
				...
				<tr>
			 	...
			 	<tr>
					<td width="80">出生时间：</td>
					<td >    
                    <input name="xs.cssj" class="mini-datepicker" required="false"  value="<s:property value="#xs.cssj"/>"/>
                </td> 
				...
				<tr>
					<td>照片</td><td><input type="file" name="zpfile" value="<s:property value="#xs.zp"/>"/></td>
				</tr>
