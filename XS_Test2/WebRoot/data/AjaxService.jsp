...
public void GetZybXs(HttpServletRequest request, HttpServletResponse response) throws Exception
{
    String zyId = request.getParameter("zyId");
    int pageIndex = Integer.parseInt(request.getParameter("pageIndex"));
    int pageSize = Integer.parseInt(request.getParameter("pageSize"));

    HashMap result = new Test.TestDB().GetZybXs(zyId, pageIndex, pageSize);
    String json = Test.JSON.Encode(result);
    response.getWriter().write(json);
}
