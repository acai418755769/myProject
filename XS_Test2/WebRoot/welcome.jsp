...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
	<head>
		...
		<link rel="stylesheet" href="download/css/960.css" type="text/css" media="screen" charset="utf-8" />
		<link rel="stylesheet" href="download/css/template.css" type="text/css" media="screen" charset="utf-8" />
		<link rel="stylesheet" href="download/css/colour.css" type="text/css" media="screen" charset="utf-8" />
		<!--[if IE]><![if gte IE 6]><![endif]-->
		<script src="download/js/glow/1.7.0/core/core.js" type="text/javascript"></script>
		<script src="download/js/glow/1.7.0/widgets/widgets.js" type="text/javascript"></script>
		<link href="download/js/glow/1.7.0/widgets/widgets.css" type="text/css" rel="stylesheet" />
			...
			<div id="content" class="container_16 clearfix">
				<div class="grid_5">
					<div class="box">
						<h2>Mathew</h2>
						<div class="utils">
							<a href="addXsView.action">View More</a>
						</div>
